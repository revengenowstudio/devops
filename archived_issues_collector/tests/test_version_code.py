...
class TestVersionCode:
    ...
    def test_version_compare(
        ...
        sorted_version_list = [*old_version_list, *new_version_list]

        def compare_version(
            left: VersionCode, right: VersionCode, operator: str, expected: bool
        ) -> None:
            match operator:
                case ">":
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                "0.99.914b3",
                ["0.99.914b3", "0.99.914c1", "0.99.915c3", "0.99.915c5"],
                "0.99.915c5",
                True,
            ),
            (
                "0.99.914p3",
                ["原版YR", "G1024", "G1024P3", "0.99.913", "0.99.916"],
                "0.99.915c3",
                False,
            ),
            (
                "0.99.915",
                ["原版YR", "G1024", "G1024P3", "0.99.915a1", "0.99.915b2", "0.99.917"],
                "0.99.916",
                False,
            ),
            (
                "0.99.915",
                ["0.99.915", "0.99.916", "0.99.916a1", "0.99.916b3"],
                "0.99.916",
                True,
            ),
            (
                "G1024B1",
                ["G1024B1", "G1024B3", "G1124", "G1124H5", "H0102", "H0102P5"],
                "H0102P5",
                True,
            ),
            (
                "G1024B1",
                ["原版YR", "E907", "E0907", "G1024", "H0102P7", "H0520", "0.99.916"],
                "H0102P5",
                False,
            ),
        ],
