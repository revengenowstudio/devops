class ErrorMessage():
    ...
    column_index_out_of_range = '''"column_index"的值超出了范围 , 请检查此行格式以及picker配置是否正确 , 错误的"column_index"位于 : {picker}'''
    
    incorrect_line_format = '''行分隔符 "{table_separator}" 无法对此行有效分隔 , 请检查此行格式是否正确'''
